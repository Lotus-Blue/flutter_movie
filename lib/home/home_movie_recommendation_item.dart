...
class MovieRecommendationItemView extends StatefulWidget {
  ...
  const MovieRecommendationItemView({Key key, this.doubanId, this.description})
      : super(key: key);
  @override
  _MovieRecommendationItemViewState createState() =>
      _MovieRecommendationItemViewState();
}

class _MovieRecommendationItemViewState
    extends State<MovieRecommendationItemView> {
  MovieDetail movie;
